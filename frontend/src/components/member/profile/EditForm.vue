...
export default {
  ...
  methods: {
    changeNumber(e) {
      ...
      const value = this.formData.password.replace(/\D/g, "");
    },
    blurPassword() {
    ...
    maskPassword() {
      this.formData.passwordNotMask = this.formData.password;
      this.mainPassword = this.formData.password;
      const arr = this.formData.password.split("");
      arr.forEach((element, index) => {
        if (element.trim() !== "") {
          arr[index] = "*";
        }
      });
      this.formData.password = arr.join("");
    },
    unMaskPassword() {
      this.formData.password = this.mainPassword;
    },
    toggleMask() {
