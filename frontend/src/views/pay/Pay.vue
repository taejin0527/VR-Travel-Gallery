  ...
  <v-container>
    <v-row>
      <v-col
        cols="12"
      >
        <div style="widht:100%; height:80px;">
        </div>
      </v-col>
      <!-- 현재 코인 잔액 표시 -->
      <v-col
      ...
      >
        <div>
          <span class="d-flex align-end" style="font-weight: bold; font-size: 25px; color:#eeeeee;">
            현재 코인 :  <div class="d-flex" style="width: 20px;"> </div>
            <span class="d-flex align-end" style="font-weight: bold; font-size: 50px; color:yellow; line-height:50px" > {{coinWallet}} </span>
      ...
      >
        <img
          src="@/assets/kakaologo.png" alt=""
          width="150px"  
        >
        <pre>  </pre>
        <span style="font-weight: bold; font-size: 25px; color:#eeeeee;">카카오페이 충전</span>
      </v-col>
      <!-- 금액 선택 -->
      ...
      >
        <div
          ...
          :class="{'hoverevent-select-charge-money':true, 'select-charge-money': selectChargeMoney[idx]}"
          @click="clickChargeMoney(idx)"
        >
          <div style="height:20px"></div>
          <div class="d-flex justify-center">
            <span style="font-weight: bold; font-size: 25px; color:yellow;">{{NCoinlist[idx]}}</span>
            <pre> </pre>
            <span style="font-weight: bold; font-size: 18px; color:#eeeeee; line-height:40px">N-Coin 충전</span>  
          </div>
          <div
      ...
      >
        ※ 카카오페이의 최소 충전금액은 5,000원이며 최대 충전금액은 50,000원입니다.
      </v-col>
      <v-col
        cols="12"
        class="d-flex justify-center"
...
export default {
  ...
  data: function () {
    return {
      ...
      selectChargeMoney: [false, false, false, false, false, false, false, false, false],
      selectMoney: null,
    }
  },
  methods:{
    clickChargeMoney: function (idx) {
      ...
      this.selectChargeMoney = [false, false, false, false, false, false, false, false, false]
